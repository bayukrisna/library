    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-orange">
                <div class="inner">
                    <h3><?php echo $dashboard['t_document_header']?>/<?php echo $dashboard['t_document_number']?></h3>

                    <p>Title / Eksemplar Total</p>
                </div>
                <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-purple">
                ...
                <a href="<?php echo base_url(); ?>Master/member" class="small-box-footer">Read More <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
    </div>
</section>