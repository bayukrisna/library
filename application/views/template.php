      ...
      <ul class="sidebar-menu">
        ...
        <?php 
          ...
          <?php } else if($this->session->userdata('level') == 3) { ?>
            ...
            <li><a href="<?php echo base_url(); ?>mahasiswa/mahasiswa_data"><i class="fa  fa-file"></i><span>Data Penerimaan Mahasiswa</span></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url(); ?>mahasiswa/mahasiswa_data"><i class="fa fa-circle-o"></i>Data Penerimaan Mahasiswa</a></li>
