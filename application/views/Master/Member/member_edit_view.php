<section class="content">
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            <?php echo form_open('Master/edit_member', 'class="form-horizontal" method="post" role="form" enctype="multipart/form-data"'); ?>
              ...
              <div class="table-responsive">
                <div class="col-md-6">
                  <div class="form-group ">
                        ...
                        <div class="col-md-7 col-sm-12 required">
                            <input class="form-control" type="text" name="userStudentId" value="<?= $member->userStudentId?>" required="" />
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-md-7 col-sm-12 required">
                          <input type="hidden" name="userId" value="<?=$member->userId ?>">
                            <input class="form-control" type="text" name="userUsername" value="<?= $member->userUsername?>" required="" />
                ...
                <div class="col-md-6">
                    <div class="form-group ">
                        ...
                        <div class="col-md-7 col-sm-12 required">
                            <input type="text" name="userCity" class="form-control" id="userCity" value="<?= $member->userCity?>">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-md-7 col-sm-12 required">
                            <input type="text" name="userAddress" class="form-control" id="userAddress" value="<?= $member->userAddress?>">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-md-7 col-sm-12 required">
                            <input type="email" name="userEmail" class="form-control" id="userEmail"  value="<?= $member->userEmail?>" required="">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-md-7 col-sm-12 required">
                            <input type="text" name="userPhone" class="form-control" id="userPhone" value="<?= $member->userPhone?>">
